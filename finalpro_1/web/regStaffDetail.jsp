...
<body>
 <%!
        ...
        int ID,i=0,j,k,l,counting,slotcount,daycount;
        char ch=',';
        String slots[],days[];
        String name,special,dob,sex,no_slot,ug,pg,joining,t_add,p_add,email;
        int empid,salary,fees,tCode,tNo;
        %>
        <%
...
<div id="search" class="boxed">
			...
			<div class="content">
                ...
                <form id="searchform" method="post" name="mainform" action="insertRegStaffDetail.jsp">
					<fieldset>
                        <form id="searchform" method="post" name="submainform" action="insertRegStaffDetail.jsp">
					    <table align="center">
      ...
      <input type="hidden" name="empID" value="<jsp:expression>empid</jsp:expression>">
              <center>
                  <table>
                      <tr>
                          <td>
              <input type="submit" value="UPDATE" name="submit"  size="5" />
                          </td>
                          <td>
              
                          </td>
                          <td>
                  <form action="organisation.jsp" method="post">
                      <center>
                      <input type="submit" value="CANCEL" name="cancel" size="5"/>
                      </center>
                  </form>
                          </td>
                      </tr>
