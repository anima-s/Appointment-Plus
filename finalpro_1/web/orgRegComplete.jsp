...
<div id="search" class="boxed">
			<h2 id="detail">Registeration complete!</h2>
			<div class="content">

                <form id="searchform" method="post" action="index.jsp">
					<fieldset>
                         <p>Congratulations!! You are successfully registered to our website.<br>
                             Please enjoy the services.<br>
                                 Thankyou for using our site.</p><br><br>
                    </fieldset><br>
                       <center>
