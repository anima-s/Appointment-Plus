...
<script language="javascript" type="text/javascript" src="C:\Documents and Settings\XP\My Documents\NetBeansProjects\WebApplication1\web\images\cal.js">
...
<%!     Connection con=null;
      ...
      rs=st.executeQuery("select work_slot_num,sno,work_slots,work_days from staffentry where orgID="+orgID+" and empID="+empID+" ");
      while(rs.next())
          {
...
%>
        ...
        <%
      res=st.executeQuery("select * from slot where empID="+empID+" and orgID="+orgID+" ");
i=0;
 while(res.next())
      {
