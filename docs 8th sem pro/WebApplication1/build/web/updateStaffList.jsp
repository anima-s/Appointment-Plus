...
<div style="width: 1000px;margin: 0 auto;padding: 30px 0;">
      <div id="search" class="boxed">
            ...
            <div class="content">
					<fieldset>
                        <form action="regStaffDetail.jsp" method="post">
                        <br>
...
<tr bgcolor="#A4C0C8">
    ...
    <input type="hidden" name="empID" value="<jsp:expression>id</jsp:expression>">
  ...
  <center>
      ...
      <table>
          <tr>
            <td><form action="organisation.jsp"><input type="submit" value=" DONE " /></form></td>
            <td><form action="makeUpdateAttributeFalse.jsp"><input type="submit" value="ADD NEW STAFF" /></form></td>
          </tr>
      </table>
  </center>
