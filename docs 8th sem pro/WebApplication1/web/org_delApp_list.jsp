...
<div style="width: 1000px;margin: 0 auto;padding: 30px 0;">
      <div id="search" class="boxed">
        ...
        int orgID,i,j,k,custID,esno,date1,date2,mySp1,mySp2,empID;
        String cname,msg="",sql="",strtodate="",strfromdate="",strtodate1="",strfromdate1="",datetoparse="",strMonth="",strDate="",strYear="",tempdatestr="";
      ...
      st=con.createStatement();
      rs=st.executeQuery("select * from slot where empID="+empID+" and orgID="+orgID+" ");
      i=1;
      while(rs.next())
          i++;
