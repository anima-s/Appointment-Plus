...
<div id="header">
	...
	<div id="menu">
        ...
        int has=0,esno,orgID,custID;
         String EmpID="",OrgID="",appdate="",slot="",CustID="",custmail="",sql="",msg,date,sender,receiver,name;
        %>
      ...
      if(has==0)
         sql="Unable to process the request for appointment.Please fill the details correctly and try again.";
          ...
          rs=st.executeQuery("select eName from staffentry where sno="+esno+" ");
          while(rs.next())
              name=rs.getString(1);
