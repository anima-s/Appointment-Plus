...
public final class namewiselist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Connection con=null;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      rs=st.executeQuery("select * from staffentry where eName='"+spname+"'");
      i=1;
      while(rs.next())
          i++;
      ...
      while(rs.next())
      {
      detail[i][1]=rs.getString("specialist");
