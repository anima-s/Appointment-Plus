...
<%!
        ...
        int counter,i,j,intdate,intgetdate,orgID;
        String eEmail="",empID="",workSlot="",workDay="",date="",slot="",fixslot="";
        String appdate="",msg="",freeslot="",str1="";
        int counting,k,l,esno;
        char ch=',';
        String slots[];
%>
...
<%
      ...
      rs=st.executeQuery("select work_slots,work_days from staffentry where orgID="+orgID+" and sno="+esno+" ");
      while(rs.next())
                   {
    ...
    res=st.executeQuery("select appdate,slot from slot where empID="+esno+" and orgID="+orgID+" ");
         ...
         while(res.next())
              {
                ...
                if(appdate.equalsIgnoreCase(res.getString(1)))
                    {
...
else
{
            ...
            if(slot.equals(workSlot))
             msg="There are no free slots . Please select another date.";
            else
            {
                 fixslot=workSlot;
                   ...
                   fixslot=fixslot.replaceAll(","+slot, "");
                 msg="The free slots are "+fixslot+".To fix the appointment select the slot and enter your email and then click ok.To select another date click select another.";
            }
}
...
<div id="search" class="boxed">
			...
			<div class="content">
                     <fieldset>
                         <center>
                             <p style="float:none;padding-top: 5px;font-size: 85%;"><strong><jsp:expression>msg</jsp:expression></strong></p><br><br>
                        <form action="servletappAvail.jsp" method="post">
                        <table>
                            <tr>
                                <td>Select Slot:</td>
                                <td>
                        ...
                        <tr>
                            <td>
                                <form id="searchform" method="post" action="servletappAvail.jsp">
                                <input type="submit" value="   Ok   "/>

                            </form>
                                    </td>
                            <td><form id="searchform" action="selectanotherApp.jsp"><input type="submit" value="Select Another"/></form></td>
                        </tr>
                        </table>
