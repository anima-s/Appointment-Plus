...
function validateCreateAccount()
{
			...
			if (document.newuser.Usermail.value == "")
				{
					alert("Please enter your email.");
					document.newuser.Usermail.focus();
					return false;
				}
			if (document.newuser.Userpwd.value == "")
				{
					alert("Please enter a password.");
					document.newuser.Userpwd.focus();
					return false;
				}
			if (document.newuser.Userpwd2.value == "")
				{
					alert("Please retype password.");
					document.newuser.Userpwd2.focus();
					return false;
				}
                if (document.newuser.Usermail.value !="")
            	{
