...
<%
      ...
      rs=st.executeQuery("select work_slots,work_days from staffentry where sno="+esno+" ");
      while(rs.next())
                   {
    ...
    res=st.executeQuery("select appdate,slot from slot where empID="+esno+" ");
			...
			<div class="content">
                     <fieldset>
                        ...
                        <tr>
                            ...
                            <td><form id="searchform" action="orgfixApp.jsp"><input type="submit" value="Select Another"/></form></td>
                        </tr>
                        </table>
