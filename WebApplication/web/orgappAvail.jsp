...
<%
        ...
        orgID=Integer.parseInt(session.getAttribute("orgID").toString());//out.println(orgID);
        empID=Integer.parseInt(session.getAttribute("empID").toString());//out.println(empID);
