...
<div id="search" class="boxed">
			<h2 id="detail">Registeration</h2>
			<div class="content">

                <form id="searchform" method="post" action="index.jsp">
					<fieldset>
                         <p>Your documents are not received by us.Your request for creating account is rejected. To create account please login again.</p><br><br>
                    </fieldset><br>
                       <center>
