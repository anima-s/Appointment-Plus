...
<div id="search" class="boxed">
            ...
            <div class="content">
                ...
                <form id="searchform" method="post" action="servletNewUserSignup.jsp" name="newuser" onSubmit="return validateCreateAccount();">
                    ...
                    <tr><td>Enter Password:</td><td><input id="searchinput" type="password" name="Userpwd"/></td></tr>
                    <tr><td>Retype Password:</td><td><input id="searchinput" type="password" name="Userpwd2"/></td></tr>
                    <tr><td>User Type:</td>
                    <td>
