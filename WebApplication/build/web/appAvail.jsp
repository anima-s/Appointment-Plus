...
<%!
        ...
        int counting,k,l,esno,mySp1,mySp2,qresult,nofreeslot=0;
...
<%
        ...
        eEmail=session.getAttribute("eEmail").toString();
...
if(fixslot.length()<4)
            ...
            {
            nofreeslot=0;
            msg="The free slots are "+fixslot+".";
            str1=fixslot+",";
            }
//for slots
			...
			<div class="content">
                     <fieldset>
                        ...
                        <tr>
                            ...
                            <td>
                                <form id="searchform" action="fixApp.jsp" method="post">
                                    ...
                                    <input type="hidden" name="eEmail" value="<jsp:expression>eEmail</jsp:expression>">
                                </form>
                            </td>
                        </tr>
                        </table>
...
else if(nofreeslot==11)
            {
        %>
<div style="width: 400px;margin: 0 auto;padding: 30px 0;">
<div id="search" class="boxed">
			<h2 id="detail">YOUR APPOINTMENTS</h2>
			<div class="content">

                <form id="searchform" method="post" action="fixApp.jsp">
					<fieldset>
                         <p>There are no free slots.</p><br><br>
                    </fieldset><br>
                       <center>
                        <input type="submit" value="  OK   " />
                        <input type="hidden" name="empID" value="<jsp:expression>empID</jsp:expression>">
