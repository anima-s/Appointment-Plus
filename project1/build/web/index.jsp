...
function validateCreateAccount()
{
			...
			if (document.loginform.Usernameinput.value == "")
				{
					alert("Please enter a username.");
					document.mainForm.Usernameinput.focus();
					return false;
				}
			if (document.loginform.Passwordinput.value == "")
				{
					alert("Please enter a password.");
					document.mainForm.Passwordinput.focus();
					return false;
				}
                return true;
	}
...
<div id="page">
	<div id="content">
		...
		<div>&nbsp;</div>
		<div>
			<img src="\ProjectAppintment\web\dentist1.gif"/>
		</div>
	</div>
	<!-- end content -->
	<div id="sidebar">
