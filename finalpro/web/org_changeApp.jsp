...
<div id="search" class="boxed">
			<h2 id="detail">Changing Appointment</h2>
			<div class="content">

                <form id="searchform" method="post" action="org_manageApp.jsp">
					<fieldset>
                        <p>To re-schedule an appointment first you have to delete the previous appointment and then again take a new appointment.</p><br>
                        <center>
