...
if(slot=="")
{
        msg="The free slots are "+workSlot+".To fix the appointment select the slot and then click ok.To select another date click select another.";
        fixslot=workSlot;
}
else
{
            ...
            if(slot.equals(workSlot))
                {
             nomsg="There are no free slots . Please select another date.";
             nofreeslot=1;
             }
            else
            {     nofreeslot=0;
			...
			<div class="content">
                     <fieldset>
                        ...
                        <tr>
                            ...
                            <td>
                                <form id="searchform" action="fixApp.jsp" method="post"><input type="submit" value="Select Another"/>
                                <input type="hidden" name="orgID" value="<jsp:expression>orgID</jsp:expression>">
...
<div id="search" class="boxed">
			...
			<div class="content">
                     <fieldset>
                         <center>
                             <p style="float:none;padding-top: 5px;font-size: 85%;"><strong><jsp:expression>nomsg</jsp:expression>
                             </strong></p><br><br>
