...
<div id="search" class="boxed">
			...
			<div class="content">
                <center>
            <h3>Related Tasks</h3><br><br>
            <a href="org_makeApp.jsp">make an appointment</a><br>
            <a href="org_changeApp.jsp">change an appointment</a><br>
            <a href="org_delApp.jsp">cancel an appointment</a><br>
            </center>
                <br><br><br>
