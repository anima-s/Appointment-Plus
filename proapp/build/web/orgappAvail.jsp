...
<%!
        ...
        int counter,i,j,intdate,nofreeslot,orgID,empID;
			...
			<div class="content">
                     <fieldset>
                        ...
                        <tr>
                            ...
                            <td>
                                <form id="searchform" action="orgfixApp.jsp"><input type="submit" value="Select Another"/>
